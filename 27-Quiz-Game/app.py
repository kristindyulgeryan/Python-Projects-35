...
def load_questions():
    general_knowledge = [
        ...
        {
            "question": "Wich of these is not a primary color?",
    ...
    movies_tv = [
        ...
        },
        {
            ...
            "options": ["A. Breaking Bad", "B. The walking Dead", "C. Game of Trones", "D. Stranger Things"],
            "answer": "A"
        },
        {
            "question": "What was first film in the Star Wars original trilogy?",
    ...
    science_nature = [
        ...
        {
            "question": "What is larges organ in the human body?",
            "options": ["A. Brain", "B. Liver", "C. Heart", "D. Skin"],
            "answer": "D"
        },
        {
            "question": "Which of these is not type of cloud?",
    ...
    video_games = [
        {
            ...
            "options": ["A. Call of Duty", "B. Super Mario Bros", "C. Mincraft", "D. Fortnite"],
            "answer": "B"
        },
        {
        ...
        {
            "question": "Which game features a character Master Chief?",
    ...
    return {
        ...
        2: {"name": "Movies and TV", "questions": movies_tv},
...
def run_quiz(category_data):
    ...
    print(f"Starting the {category_name} quiz!")
    print("ANswer each question by typing letter of your choice (A,B,C or D).")
    ...
    if percentage == 100:
        ...
        print("\n Not Bad! There's a room for improvement.")
    else:
