...
def generate_password(length, use_lowercase, use_uppercase, use_numbers, use_special):
    ...
    if not chars:
        print("Oops! No character types selected. Using letters by default!")
        chars = string.ascii_lowercase
...
def main():
    ...
    print(" Even strong passwords need to be secret")

    if get_yes_no_input("\nWould you like to create another awsome password?"):
        main()
    else:
