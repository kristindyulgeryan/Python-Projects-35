...
def add_task():
    ...
    if task:
        ...
        messagebox.showwarning("Warnig", "Please enter a task!")
...
task_listbox = tk.Listbox(list_frame, width=45, height=12, font=(
    "Arial", 12), selectmode=tk.SINGLE, yscrollcommand=scrollbar.set)
